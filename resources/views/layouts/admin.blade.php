        ...
        <li class="nav-item">
            ...
            <div id="collapseResep" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{route('resep')}}">Tambah Resep</a>
                    <div class="collapse-divider"></div>
                    <a class="collapse-item" href="{{route('daftar_resep')}}">Daftar Resep</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                ...
                <h6 class="collapse-header">Penggajian</h6>
                    <a class="collapse-item" href="{{route('gaji')}}">Gaji</a>
                    <div class="collapse-divider"></div>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Tes</span>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; 2021 Kana's Kitchen</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
